...
const questions: { text: string; id?: number }[] = [
  ...
  { text: 'Как вы предсказываете риски или задержки в проекте?' },
  { text: 'Как вы собираете и анализируете фидбэк от участников?' },
  {
    text: 'Какие рутинные процессы можно автоматизировать в аналитике?',
  },
  { text: 'С какими аналогичными проектами вы сравниваете результаты?' },
];
