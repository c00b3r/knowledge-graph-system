...
export default function ContextMenu({
  ...
  const [isParagraphMenuVisible, setIsParagraphMenuVisible] = useState(false);
  const [isInsertMenuVisible, setIsInsertMenuVisible] = useState(false);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseEnter={() => {
          setIsParagraphMenuVisible(true);
          setIsInsertMenuVisible(false);
        }}
      >
        <span className='context-menu-item-icon'>
          <ParagraphIcon />
        ...
        {isParagraphMenuVisible && <ParagraphMenu />}
      </button>
      <button
        className='context-menu-item'
        style={{ position: 'relative' }}
        onMouseEnter={() => {
          setIsInsertMenuVisible(true);
          setIsParagraphMenuVisible(false);
        }}
      >
        <span className='context-menu-item-icon'>
          <PasteElementIcon />
        ...
        {isInsertMenuVisible && <InsertMenu />}
      </button>
      <div className='context-menu-divider' />
      <button
        className='context-menu-item'
